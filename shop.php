    ...
    <div class="container-fuild fixed-top">
        <!-- nav -->
            <ul class="nav bg-white shoploc pb-0">
                ...
                <li class="nav-item ml-2 w-20">
                    <a href="cart.php" class="nav-link mr-0 pt-3 px-1" href="#">
                                    ...
                                    $row_cart=mysqli_fetch_array($run_cart);
                                        ...
                                        <div class='col-6'>
                                            <div class='row'>
                                                ...
                                                <input type='numeric' name='' id='' class='cart_qty' placeholder='' value='$pro_qty' aria-describedby='helpId'>
                                                <form action='shop.php?add_cart=$pro_id' class='form-horizontal' method='post'>
                                                <button class='btn btn-qty px-2'><i style='font-size:1rem; color:#fff;' class='fas fa-plus'></i></button>
                                                </form>
                                            </div>
...
<!-- checkout float -->
    <div class="container-fluid cart_bottom fixed-bottom mx-0 <?php echo diaplay_cart(); ?>">
            <div class="row">
                ...
                <div class="col-6 p-2   ">
                    <a href="cart.php" class="btn btn-success pull-right mx-3 bill_checkout">
                        View Cart
