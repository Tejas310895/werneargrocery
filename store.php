...
<?php
                    ...
                    <div class="col-8">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <form action='shop?store_id=<?php echo $store_id; ?>' class='form-horizontal' method='post'>
                                    <div class='col-12'>
    ...
    ?>
        ...
        <div class="row bg-white mt-1 py-2">
                    <div class="col-4">
                        <img src="admin_area/product_images/<?php echo $cat_store_img; ?>" alt="..." class="img-thumbnail border-0">
                    </div>
                    <div class="col-8">
